...
- Make sure the correct JWT token is being used in every other endpoint in the "Authorization" tab aswell.
  ...
  - This endpoint returns a list of products filtered by category and price range from the external API or Cache if the JWT token is correct: [click here](https://www.postman.com/material-participant-99475696/workspace/my-workspace/request/36477190-d5fd2412-65bc-4254-93e9-fe3b58b1ad5d?action=share&creator=36477190&ctx=documentation)
  - This endpoint returns a list of products filtered by category from the external API or Cache if the JWT token is correct: [click here](https://www.postman.com/material-participant-99475696/workspace/my-workspace/request/36477190-b5e37fd5-a84c-4d3b-b2d4-2740eb41ce93?action=share&creator=36477190&ctx=documentation)
  - This endpoint returns a list of products filtered by price range from the external API or Cache if the JWT token is correct: [click here](https://www.postman.com/material-participant-99475696/workspace/my-workspace/request/36477190-c2a8271a-89b2-4079-85a1-3a01784e5849?action=share&creator=36477190&ctx=documentation)
  - This endpoint returns a list of products filtered by search from the external API or Cache if the JWT token is correct: [click here](https://www.postman.com/material-participant-99475696/workspace/my-workspace/request/36477190-6c7ad224-de59-46b9-aa4f-0d49fa412cf4?action=share&creator=36477190&ctx=documentation)
